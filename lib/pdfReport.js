...
function buildReportHTML(data,result){
  ...
  const insight=score>=80
    ?'Ihre Immobilie weist eine \u00fcberdurchschnittliche Qualit\u00e4t auf. Das Marktumfeld am Z\u00fcrichsee ist g\u00fcnstig \u2014 eine zeitnahe Vermarktung verspricht einen optimalen Erl\u00f6s.'
    :score>=60
    ?'Ihre Immobilie hat solide Ausgangsbedingungen. Mit gezielten Massnahmen l\u00e4sst sich der Verkaufspreis optimieren. Gerne beraten wir Sie pers\u00f6nlich.'
