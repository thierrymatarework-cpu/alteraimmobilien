...
module.exports = async function handler(req, res) {
  ...
  return res.status(200).json({
    ...
    value: result.total,
    score: result.score,
    vermarktungDauer:  marketData.vermarktungDauer,
    vergleichsObjekte: marketData.vergleichsObjekte,
    nachfrageFaktor:   marketData.nachfrageFaktor,
    radiusKm:          marketData.radiusKm,
  });
};
